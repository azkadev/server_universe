...
class NestedRoute {
  final ServerUniverseNative _server_universe_dart;
  final String _basePath;
  final List<FutureOr Function(HttpRequest req, HttpResponse res)>
      _baseMiddleware;

  NestedRoute(
      {required ServerUniverseNative server_universe_dart,
      required String basePath,
      required List<FutureOr Function(HttpRequest req, HttpResponse res)>
          baseMiddleware})
      : _server_universe_dart = server_universe_dart,
        _basePath = basePath,
  ...
  NestedRoute route(String path,
          {List<FutureOr Function(HttpRequest req, HttpResponse res)>
              middleware = const []}) =>
      NestedRoute(
          server_universe_dart: _server_universe_dart,
  ...
  HttpRoute _createRoute(
    ...
    _server_universe_dart.routes.add(route);
    return route;
  }
}
