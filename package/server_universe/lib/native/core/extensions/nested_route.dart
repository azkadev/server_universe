...
class NestedRoute {
  ...
  HttpRoute get(String path,
          ...
          {List<FutureOr Function(HttpRequest req, HttpResponse res)>
              middleware = const []}) =>
      _createRoute(path, callback, ServerUniverseMethodType.get, middleware);
  ...
  HttpRoute post(String path,
          ...
          {List<FutureOr Function(HttpRequest req, HttpResponse res)>
              middleware = const []}) =>
      _createRoute(path, callback, ServerUniverseMethodType.post, middleware);
  ...
  HttpRoute put(String path,
          ...
          {List<FutureOr Function(HttpRequest req, HttpResponse res)>
              middleware = const []}) =>
      _createRoute(path, callback, ServerUniverseMethodType.put, middleware);
  ...
  HttpRoute delete(String path,
          ...
          {List<FutureOr Function(HttpRequest req, HttpResponse res)>
              middleware = const []}) =>
      _createRoute(path, callback, ServerUniverseMethodType.delete, middleware);
  ...
  HttpRoute patch(String path,
          ...
          {List<FutureOr Function(HttpRequest req, HttpResponse res)>
              middleware = const []}) =>
      _createRoute(path, callback, ServerUniverseMethodType.patch, middleware);
  ...
  HttpRoute options(String path,
          ...
          {List<FutureOr Function(HttpRequest req, HttpResponse res)>
              middleware = const []}) =>
      _createRoute(
          path, callback, ServerUniverseMethodType.options, middleware);
  ...
  HttpRoute all(String path,
          ...
          {List<FutureOr Function(HttpRequest req, HttpResponse res)>
              middleware = const []}) =>
      _createRoute(path, callback, ServerUniverseMethodType.all, middleware);
