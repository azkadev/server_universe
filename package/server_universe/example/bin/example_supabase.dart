...
import 'package:server_universe/http_client/http_client.dart';

void main() async {
  print("start");
  ServerUniverseHttpClient serverUniverseHttpClient = ServerUniverseHttpClient();
  serverUniverseHttpClient.client();
