...
class ServerUniversePubspecSupabaseConfig extends JsonScheme {
  ...
  static Map get defaultData {
    return {"@type":"serverUniversePubspecSupabaseConfig","input_file":"bin/example_server_universe_supabase.dart","output_directory":"supabase/functions/example/"};
  }
...
Map serverUniversePubspecSupabaseConfig_data_create_json = {
      ...
      "output_directory": output_directory,
          ...
          serverUniversePubspecSupabaseConfig_data_create_json.removeWhere((key, value) => value == null);
ServerUniversePubspecSupabaseConfig serverUniversePubspecSupabaseConfig_data_create = ServerUniversePubspecSupabaseConfig(serverUniversePubspecSupabaseConfig_data_create_json);
