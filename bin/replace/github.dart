...
git init
git branch -M main
git remote add origin https://github.com/azkadev/server_universe
git remote set-url --push origin https://azkadev:{main_github_token}@github.com/azkadev/server_universe
