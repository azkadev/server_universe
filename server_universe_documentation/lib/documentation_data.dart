...
DocumentationData documentationData = DocumentationData.create(
  title: "Server Universe Documentation",
  logo: "assets/logo/logo.png",
  description: """
Server Universe adalah library yang memanfaatkan api telegram untuk di implementasikan ke berbagai platform, library ini user friendly
...
**Server Universe** Dart **library** for make telegram base flutter **bot**, **userbot**, **App** Support Run Server Side And Client Side, This library 100% easy for make multiples **client or accounts** because this library you just call function not execute shell command so update account will show at function event emitter
...
"""
    ...
    DocsData.create(
      ...
      title: "Server Universe",
      description: """
Server Universe merupakan library resmi yang saya buat, metode ini saya gunakan di semua project saya,
